...
urlpatterns = [
    ...
    path("api/bills/<str:bill_id>/delete", v.api_bill_delete, name="billing_api_bill_delete"),
    ...
    path("bills/<str:bill_id>/pay-batch/", v.pay_debt_batch, name="pay_debt_batch"),
    ...
    path("bills/<str:bill_id>/", v.bill_view, name="billing_bill_view"),
    path("bills/<str:bill_id>/returns-wizard/",v.bill_return_wizard,name="billing_bill_return_wizard"),
