...
urlpatterns = [
    ...
    path("manager/receipts/", views.receipt_explorer, name="receipt_explorer"),
    path("manager/document-trace/", views.document_trace, name="document_trace"),
    path("manager/reconciliation/", views.reconciliation_dashboard, name="reconciliation_dashboard"),
