...
class TotalsPrecisionConsistencyTests(SimpleTestCase):
    ...
    def test_ui_totals_formatters_force_two_decimals(self):
        ...
        self.assertIn("minimumFractionDigits: 2", billing_js)
        self.assertIn("maximumFractionDigits: 2", billing_js)
        self.assertIn("toFixed(2)", manager_overview)
        self.assertIn("function money2(num)", return_wizard)
        self.assertIn("toFixed(2)", return_wizard)
